...
public class EvreteConfiguration {
    ...
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("gr.netmechanics.jmix.evrete"));
        return viewControllers;
    }

    @Bean("evrete_EvreteActions")
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("gr.netmechanics.jmix.evrete"));
        return actions;
    }
}
