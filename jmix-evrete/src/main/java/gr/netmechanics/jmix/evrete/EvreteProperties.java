...
public class EvreteProperties {
    ...
    /**
     * Allows {@link DefaultFactsProvider} to be applicable when {@code entitySelectionMode} is {@code ANNOTATED}.
     */
    private final boolean defaultFactsProviderForceAnnotatedApplicable;

    /**
     * Allows {@link DefaultFactsProvider} to be inapplicable when {@code entitySelectionMode} is {@code NORMAL}.
     */
