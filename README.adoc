...
image:./docs/rulset1.png[width=412,target=_blank]
image:./docs/rulset2.png[width=412,target=_blank]
image:./docs/rulset3.png[width=412,target=_blank]
image:./docs/rulset4.png[width=412,target=_blank]